...
class GuestbookForm {
	...
	/**
	 * Returns the value bount to the {@code email} attribute of the request. Needs to be public so that Spring will
	 * actually consider it for the form data binding until
	 * {@link https://github.com/spring-projects/spring-framework/issues/22600} is resolved.
	 *
