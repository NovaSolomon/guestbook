...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "first!!!", "hacker@bruh.cap"), //
					new GuestbookEntry("Arni", "Hasta la vista, baby", "Arni.nold@web.de"), //
					new GuestbookEntry("Duke Nukem",
							"It's time to kick ass and chew bubble gum. And I'm all out of gum.", "dudebro@chadbot.com"), //
					new GuestbookEntry("Gump1337",
							"Mama always said life was like a box of chocolates. You never know what you're gonna get.",
							"fast.boiii@murica.com")) //
